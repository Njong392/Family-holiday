...
const FilteredAccommodations = ({submitted}) => {
    ...
    const fetchFilteredAccommodations = async() => {
        setIsLoading(true)
        const response = await fetch(`http://localhost:4000/api/accommodation/filter/accommodations/?destination=${hostCountry}&numberOfGuests=${guests}&budget=${amount}&arrivalDate=${arrival}&departureDate=${departure}`)
  ...
  return (
    <div className="mt-12">
      <h3 className="text-3xl font-bold text-blue mt-12">Your Filtered Accommodations</h3>
