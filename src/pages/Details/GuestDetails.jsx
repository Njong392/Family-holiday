...
export default function GuestDetails() {
    return(
        <main aria-label="Main Section" className="font-poppins">
            ...
            <h3 className="text-3xl font-bold text-blue mt-12">Guest Profile</h3>
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 md:gap-8 mt-4">
                    ...
                    <div>
                        ...
                        <div className='flex items-center gap-1'>
                            ...
                            <p className="text-sm font-bold text-blue">Sydney, Australia</p>

                        </div>

                        <div className="mt-1 text-deepgray">
                            <p className="text-sm"><span className="font-bold">Number of family members:</span> 2, 4-28 years old</p>
                            <p className="text-sm"><span className="font-bold">Laguage(s) spoken:</span> English</p>
                        </div>
                ...
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 md:gap-8 mt-4">
                        ...
                        className="h-56 w-full object-cover rounded-xl shadow-xl"/>
                ...
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-6 md:grid-cols-2 md:gap-8 mt-12">
                        <div className="bg-snow p-4 rounded-xl shadow-xl">        
                            <div className="flex gap-1 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-deepgray h-6 w-6"><path fill="none" d="M0 0h24v24H0z"></path><path d="M2 11H22V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V11ZM17 3H21C21.5523 3 22 3.44772 22 4V9H2V4C2 3.44772 2.44772 3 3 3H7V1H9V3H15V1H17V3Z"></path></svg>
                                 <p className="text-sm font-extrabold text-deepgray">Duration of stay</p>
                            </div>
                        ...
                        <div className="bg-snow p-4 rounded-xl shadow-xl">    
                          <div className="flex gap-1 items-center">
                                ...
                                <p className="text-sm font-extrabold text-deepgray">Cuisine</p>
                           </div>
                           <p className="mt-2">We love french cuisine</p>
                        </div>

                        <div className="bg-snow p-4 rounded-xl shadow-xl">
                           <div className="flex gap-1 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-deepgray h-8 w-8"><path fill="none" d="M0 0h24v24H0z"></path><path d="M14 8.94737L22 14V16L14 13.4737V18.8333L17 20.5V22L12.5 21L8 22V20.5L11 18.8333V13.4737L3 16V14L11 8.94737V3.5C11 2.67157 11.6716 2 12.5 2C13.3284 2 14 2.67157 14 3.5V8.94737Z"></path></svg>
                                <p className="text-sm font-extrabold text-deepgray">Preferred destination</p>
                           </div>
                        ...
                        <div className="bg-snow p-4 rounded-xl shadow-xl">
                           <div className="flex gap-1 items-center">
                                ...
                                <p className="text-sm font-extrabold text-deepgray">Hobbies</p>
                           </div>
                        ...
                        <div className="bg-snow p-4 rounded-xl shadow-xl">
                           <div className="flex gap-1 items-center">
                                ...
                                <p className="text-sm font-extrabold text-deepgray">Allergies</p>
                           </div>
                        ...
                        <div className="bg-snow p-4 rounded-xl shadow-xl">
                           <div className="flex gap-1 items-center">
                                ...
                                <p className="text-sm font-extrabold text-deepgray">Additional info</p>
                           </div>
                        ...
                        <div className="bg-snow p-4 rounded-xl shadow-xl">
                           <div className="flex gap-1 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-deepgray h-6 w-6"><path fill="none" d="M0 0h24v24H0z"></path><path d="M22.0049 6H15.0049C11.6912 6 9.00488 8.68629 9.00488 12C9.00488 15.3137 11.6912 18 15.0049 18H22.0049V20C22.0049 20.5523 21.5572 21 21.0049 21H3.00488C2.4526 21 2.00488 20.5523 2.00488 20V4C2.00488 3.44772 2.4526 3 3.00488 3H21.0049C21.5572 3 22.0049 3.44772 22.0049 4V6ZM15.0049 8H23.0049V16H15.0049C12.7957 16 11.0049 14.2091 11.0049 12C11.0049 9.79086 12.7957 8 15.0049 8ZM15.0049 11V13H18.0049V11H15.0049Z"></path></svg>
                                <p className="text-sm font-extrabold text-deepgray">Budget</p>
                           </div>
                           <p className="mt-2">$50/night excluding infants</p>
                        </div>                        
