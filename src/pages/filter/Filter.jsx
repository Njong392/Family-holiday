...
const Filter = () => {
  ...
  return (
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 font-poppins">
            ...
            <p className="text-green text-sm mt-4 font-bold">
              ...
              <div className="col-span-6 ">
                <label
                  ...
                  className="block font-medium text-deepgray"
                >
                  What language(s) do you speak or do you wish to learn from the host family?
                </label>
      ...
      {(!accommodations && isSubmitted) && (<Verification text={"Oops. We found no accommodations that fit that criteria."} />)}
    </div>
  )
}
