          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
              <div className="flex gap-4">
                ...
                {accommodation && <p>{accommodation.bedrooms} Bedroom(s)</p>}
              </div>
              ...
              <div className="flex gap-4">
                ...
                {accommodation && <p>{accommodation.bathrooms} Bathroom(s)</p>}
              </div>
              ...
              <div className="flex gap-4">
                ...
                {accommodation && <p>{accommodation.beds} Bed(s)</p>}
              </div>
              ...
              <div className="flex gap-4">
                ...
                {accommodation && (
                  <p>
                    Available from{" "}
                    {moment(accommodation.arrivalDate).format("MMMM D")} -{" "}
                    {moment(accommodation.departureDate).format("MMMM D")}
                  </p>
                )}
              </div>
            </div>
            ...
            <div>
              {accommodation && (
                <p className="mt-2">
                  Reach out to the{" "}
                  <Link
                    to={`/profile/?userId=${accommodation.user_id}`}
            ...
            <div>
              {accommodation && (
                <p className="mt-4 line-clamp-2">{accommodation.description}</p>
              )}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <svg
                        ...
                        className={
                          adultDisabled
                            ? "w-8 h-8 text-lightgray opacity-25"
                            : "w-8 h-8 text-lightgray"
                        }
                      >
                        <path
                          strokeLinecap="round"
                    ...
                    <button onClick={incrementAdultCount}>
                      <svg
                        ...
                        strokeWidth={1.5}
                        stroke="currentColor"
                        className="w-8 h-8 text-lightgray cursor-pointer"
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
